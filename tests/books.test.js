...
describe("PUT /books/:id", function () {
  test("Updates a single book", async function () {
    ...
    expect(response.body).toHaveProperty("book"); // Check if the response has a 'book' property
  ...
  test("Prevents a bad book update", async function () {
    ...
    expect(response.statusCode).toBe(400); // Check if it returns a 400 status
  });
